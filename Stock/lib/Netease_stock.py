...
import urllib2,re,sys,datetime,xlrd,StringIO
from common_tool import save_file_from_url, print_log
from Sys_paths import Sys_paths
from object.Netease_stock_object import Netease_stock_object
...
class Netease_stock:
    ...
    def __init__(self, code, date):
        ...
        self.__download_file = Sys_paths.DATA_STOCK_TRANSACTION + Sys_paths.SEP + 'netease_' + self.__date + '_' + self.__code + '.xls'
    ...
    def get_stock_object(self):
        ...
        for code in self.get_stock_content():
            ...
            for date in self.get_stock_content()[code]:
                ...
                out_object[code][date] = Netease_stock_object(code, date, rows)
                buf.close()
        return out_object
...
if __name__ == "__main__":
    s = Netease_stock("300499", "20160318")
    c = s.get_stock_content()
    print c['300499']['20160318']
